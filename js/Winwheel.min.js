    ...
    if (this.ctx && this.segments)
        for (x = 1; x <= this.numSegments; x++)
            if (seg = this.segments[x], seg.imgData.height) {
                var a, b, c;
                a = null !== seg.imageDirection ? seg.imageDirection : this.imageDirection;
                "S" == a ? (a = this.centerX - seg.imgData.width / 2, b = this.centerY, c = seg.startAngle + 180 + (seg.endAngle - seg.startAngle) / 2) : "E" == a ? (a = this.centerX, b = this.centerY - seg.imgData.height / 2, c = seg.startAngle + 270 + (seg.endAngle - seg.startAngle) / 2) : "W" == a ? (a = this.centerX - seg.imgData.width, b = this.centerY -
                    seg.imgData.height / 2, c = seg.startAngle + 90 + (seg.endAngle - seg.startAngle) / 2) : (a = this.centerX - seg.imgData.width / 2, b = this.centerY - seg.imgData.height, c = seg.startAngle + (seg.endAngle - seg.startAngle) / 2);
                this.ctx.save();
                this.ctx.translate(this.centerX, this.centerY);
        ...
        for (x = 1; x <= this.numSegments; x++) {
            ...
            if (seg.text)
                for (a = null !== seg.textFontFamily ? seg.textFontFamily : this.textFontFamily, b = null !== seg.textFontSize ? seg.textFontSize : this.textFontSize, c = null !== seg.textFontWeight ? seg.textFontWeight : this.textFontWeight, l = null !== seg.textOrientation ? seg.textOrientation : this.textOrientation, e = null !== seg.textAlignment ? seg.textAlignment : this.textAlignment, n =
                    ...
                    if ("reversed" == n)
                        if ("horizontal" == l) this.ctx.textAlign = "inner" == e ? "right" : "outer" == e ? "left" : "center", this.ctx.textBaseline = "middle", d = this.degToRad(seg.endAngle - (seg.endAngle - seg.startAngle) / 2 + this.rotationAngle - 90 - 180), this.ctx.save(), this.ctx.translate(this.centerX, this.centerY), this.ctx.rotate(d), this.ctx.translate(-this.centerX, -this.centerY), "inner" == e ? (k && this.ctx.fillText(a[i], this.centerX - this.innerRadius - f, this.centerY + c), m &&
                            this.ctx.strokeText(a[i], this.centerX - this.innerRadius - f, this.centerY + c)) : "outer" == e ? (k && this.ctx.fillText(a[i], this.centerX - this.outerRadius + f, this.centerY + c), m && this.ctx.strokeText(a[i], this.centerX - this.outerRadius + f, this.centerY + c)) : (k && this.ctx.fillText(a[i], this.centerX - this.innerRadius - (this.outerRadius - this.innerRadius) / 2 - f, this.centerY + c), m && this.ctx.strokeText(a[i], this.centerX - this.innerRadius - (this.outerRadius - this.innerRadius) / 2 - f, this.centerY + c)), this.ctx.restore();
                        else if ("vertical" ==
                        l) {
                        ...
                        g = b - b / 9;
                        if ("outer" == e)
                            for (d = a[i].length - 1; 0 <= d; d--) character = a[i].charAt(d), k && this.ctx.fillText(character,
                                this.centerX + c, h), m && this.ctx.strokeText(character, this.centerX + c, h), h -= g;
                        else if ("inner" == e)
                            for (d = 0; d < a[i].length; d++) character = a[i].charAt(d), k && this.ctx.fillText(character, this.centerX + c, h), m && this.ctx.strokeText(character, this.centerX + c, h), h += g;
                        else if ("center" == e)
                            for (h = 0, 1 < a[i].length && (h = g * (a[i].length - 1) / 2), h = this.centerY + this.innerRadius + (this.outerRadius - this.innerRadius) / 2 + h + f, d = a[i].length - 1; 0 <= d; d--) character = a[i].charAt(d), k && this.ctx.fillText(character, this.centerX + c, h), m && this.ctx.strokeText(character,
                        ...
                        if ("curved" == l) {
                            ...
                            var q = 0,
                                p;
                            1 < a[i].length ? (this.ctx.textAlign = "left", q = b / 10 * 4, radiusPercent = 100 / g, q *= radiusPercent, totalArc = q * a[i].length, p = seg.startAngle + ((seg.endAngle - seg.startAngle) / 2 - totalArc / 2)) : (p =
                                seg.startAngle + (seg.endAngle - seg.startAngle) / 2, this.ctx.textAlign = "center");
                            p += this.rotationAngle;
                            p -= 180;
                            for (d = a[i].length; 0 <= d; d--) this.ctx.save(), character = a[i].charAt(d), this.ctx.translate(this.centerX, this.centerY), this.ctx.rotate(this.degToRad(p)), this.ctx.translate(-this.centerX, -this.centerY), m && this.ctx.strokeText(character, this.centerX, this.centerY + g + c), k && this.ctx.fillText(character, this.centerX, this.centerY + g + c), p += q, this.ctx.restore()
                        }
                        ...
                        e ? "left" : "outer" == e ? "right" : "center", this.ctx.textBaseline = "middle", d = this.degToRad(seg.endAngle - (seg.endAngle - seg.startAngle) / 2 + this.rotationAngle - 90), this.ctx.save(), this.ctx.translate(this.centerX, this.centerY), this.ctx.rotate(d), this.ctx.translate(-this.centerX, -this.centerY), "inner" == e ? (k && this.ctx.fillText(a[i], this.centerX + this.innerRadius + f, this.centerY + c), m && this.ctx.strokeText(a[i], this.centerX + this.innerRadius + f, this.centerY + c)) : "outer" == e ? (k && this.ctx.fillText(a[i], this.centerX + this.outerRadius -
                            f, this.centerY + c), m && this.ctx.strokeText(a[i], this.centerX + this.outerRadius - f, this.centerY + c)) : (k && this.ctx.fillText(a[i], this.centerX + this.innerRadius + (this.outerRadius - this.innerRadius) / 2 + f, this.centerY + c), m && this.ctx.strokeText(a[i], this.centerX + this.innerRadius + (this.outerRadius - this.innerRadius) / 2 + f, this.centerY + c)), this.ctx.restore();
                    else if ("vertical" == l) {
                        this.ctx.textAlign = "center";
                        this.ctx.textBaseline = "inner" == e ? "bottom" : "outer" == e ? "top" : "middle";
                        d = seg.endAngle - (seg.endAngle - seg.startAngle) /
                            2;
                        d += this.rotationAngle;
                        this.ctx.save();
                        this.ctx.translate(this.centerX, this.centerY);
                        ...
                        if ("outer" == e)
                            ...
                            for (d = a[i].length - 1; 0 <= d; d--) character = a[i].charAt(d),
                                k && this.ctx.fillText(character, this.centerX + c, h), m && this.ctx.strokeText(character, this.centerX + c, h), h -= g;
                        else if ("center" == e)
                            for (h = 0, 1 < a[i].length && (h = g * (a[i].length - 1) / 2), h = this.centerY - this.innerRadius - (this.outerRadius - this.innerRadius) / 2 - h - f, d = 0; d < a[i].length; d++) character = a[i].charAt(d), k && this.ctx.fillText(character, this.centerX + c, h), m && this.ctx.strokeText(character, this.centerX + c, h), h += g;
                        this.ctx.restore()
                    } else if ("curved" == l)
                        for (g = 0, "inner" == e ? (g = this.innerRadius + f, this.ctx.textBaseline = "bottom",
                            ...
                            character = a[i].charAt(d), this.ctx.translate(this.centerX, this.centerY), this.ctx.rotate(this.degToRad(p)), this.ctx.translate(-this.centerX, -this.centerY), m && this.ctx.strokeText(character, this.centerX, this.centerY - g + c), k && this.ctx.fillText(character, this.centerX, this.centerY - g + c), p += q, this.ctx.restore();
                    c += b
                }
            this.ctx.restore()
        }
...
Winwheel.prototype.getSegmentNumberAt = function (a, b) {
    var c = this.windowToCanvas(a, b),
        l, e, n, f;
    c.x > this.centerX ? (n = c.x - this.centerX, e = "R") : (n = this.centerX - c.x, e = "L");
    c.y > this.centerY ? (f = c.y - this.centerY, l = "B") : (f = this.centerY - c.y, l = "T");
    var k = 180 * Math.atan(f / n) / Math.PI,
        c = 0;
    n = Math.sqrt(f * f + n * n);
    "T" == l && "R" == e ? c = Math.round(90 - k) : "B" == l && "R" == e ? c = Math.round(k + 90) : "B" == l && "L" == e ? c = Math.round(90 - k + 180) : "T" == l && "L" == e && (c = Math.round(k + 270));
    0 != this.rotationAngle && (e = this.getRotationPosition(), c -= e, 0 > c && (c =
        360 - Math.abs(c)));
    e = null;
...
Winwheel.prototype.getRotationPosition = function () {
    ...
    if (0 <= a) {
        if (360 < a) var b = Math.floor(a / 360),
            a = a - 360 * b
...
function winwheelStopAnimation(a) {
    0 != a && null != winwheelToDrawDuringAnimation.animation.callbackFinished && eval(winwheelToDrawDuringAnimation.animation.callbackFinished)
}
