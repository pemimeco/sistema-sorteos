class Externa {
    ...
    iniciarTablaExt(fl) {
        $('#tbExterna').DataTable({
            ...
            "pageLength": 5,
            "processing": true,
            ajax: `http://localhost:3000/api/obtenerAprobados/${fl}`,
            columns: [{
                    data: 'idcaso',
                    visible: false
                }, {
    ...
    iniciarTablaSorteo(fl) {
        $('#tbSorteos').DataTable({
            ...
            "pageLength": 5,
            "processing": true,
            ajax: `http://localhost:3000/api/obtenerSorteos/${fl}/EXTERNA`,
            columns: [{
                    data: 'idarea',
                    visible: false
                }, {
    ...
    llenarDatos = (codigoEst) => {
        ...
        fetch(`http://localhost:3000/api/obtenerDetalles/${codigoEst}/EXTERNA`)
            .then((response) => {
